...
//    private final Fruit fruit2;
    ...
    public Smoothie(String name, Milk milk, Protein protein, boolean ice, Fruit fruit1) {
        this.name = name;
        this.milk = milk;
...
//        this.fruit2 = fruit2;
    ...
    public String toString() {
        ...
        ret += "and " + fruit1.getName();
        return ret;
    }

    public String getNutritionalVal() {
        NutritionalValue totalNValue =  NutritionalValue.getTotalNutritionalValue(milk.getNValue(), protein.getNValue(), fruit1.getNValue());
//        return fruit1.getNValue().toString();
